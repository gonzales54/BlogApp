...
export function SearchIcon() {
  return (
    <span className={style.searchIconWrap}>
      <svg
...
export function NavBarIcon() {
  return (
    <span className={style.withoutBackgroundColorWrap}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
...
export function HomeIcon({ className }: { className: string }) {
  return (
    <span className={`${className} ${style.withoutPaddingWrap}`}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
...
export function HandleSideBarIcon({
  isSideBarOpen,
}: {
